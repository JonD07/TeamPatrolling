...
# Build the filename
file_name = f"plot_{NUM_UGV}_{NUM_UAV}_{NUM_NODES}_{NUM_OBSTACLES}_{next_file_number}.yaml"
...
for i in range(1, NUM_OBSTACLES + 1):
    obstacle = {
        ...
        'radius': round(random.uniform(OBSTACLE_SIZE_LOWER_BOUND, OBSTACLE_SIZE_UPPER_BOUND), 1)
    }
...
print(f"✅ Scenario file written to {full_path}")
